...
class Akinator(commands.Cog):
    ...
    async def akinator(self,ctx):
        intro=nextcord.Embed(title="Akinator",description="Hello, "+ctx.author.mention+"I am Akinator!!!",color=nextcord.Colour.blue())
        ...
        bye=nextcord.Embed(title="Akinator",description="Bye, "+ctx.author.mention,color=nextcord.Colour.blue())
        ...
        try:
            ...
            while aki.progression <= 80:
                question=nextcord.Embed(title="Question",description=q,color=nextcord.Colour.blue())
                ...
                if msg.content.lower() in ["b","back"]:
                    ...
                    try:
                        q = aki.answer(str(msg.content.lower()))
                    except Exception as e:
                        await ctx.send(e)
                        continue
            aki.win()
            answer=nextcord.Embed(title=aki.first_guess['name'],description=aki.first_guess['description'],color=nextcord.Colour.blue())
